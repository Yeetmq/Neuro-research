...
from core.utils import save_to_file, logger
...
class SummarizationParser:
    ...
    def run(self):
        ...
        self.web_handler.parse_pages(links=webpage_links, result_path=self.config['result_path'])
        ...
        save_to_file(arxiv_texts, self.config['result_path'])
